...
\documentclass[oneside, bachelor]{BIT-thesis-grd}
...
% \UDC{540}
\title{基于碳足迹分析的中美半导体产业贸易与环境影响研究}
\vtitle{基于碳足迹分析的中美半导体产业贸易与环境影响研究}
\author{张峰铭}
\institute{经管书院}
\advisor{唐葆君教授}
\chairman{**教授}
...
% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Trade and Environmental Implications of \\the Chinese and American Semiconductor Sectors: A Carbon Footprint Approach}
\englishauthor{Fengming Zhang}
\englishadvisor{Prof. Tang}
\englishchairman{Prof. **}
\englishschool{Beijing Institute of Technology}
\englishinstitute{School of Management and Econmics}
\englishdegree{Bachelor's Degree}
\englishmajor{International Trade and Economics}
...
\bibliography{reference//chap1,reference//chap2,reference//chap3,reference/storage,reference/no_trade}
